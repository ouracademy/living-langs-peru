...
| T6.2  | `src/components/help-education.tsx`: su tarjeta «Games» pasa a «Juegos» y su `href` de `/juegos` (que no existía) al juego. **Solo eso**; el resto del home se queda como está.                                             | S    | AC-G4-16            |
