  ...
  return (
    <section className="relative overflow-hidden min-h-[560px] flex items-center">
      ...
      <div className="max-w-[1180px] mx-auto px-8 relative z-[2] w-full">
        <span className="font-['Mulish',sans-serif] inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full font-bold text-sm shadow-[0_2px_0_rgba(36,29,20,0.08)]">
          <span className="w-2 h-2 rounded-full bg-[#E4572E]" />
          Asháninka · Uro
        </span>
        <h1 className="font-['Baloo_2',sans-serif] font-bold text-4xl md:text-5xl leading-tight my-4 text-white max-w-[16ch]">
          Aprende, juega y <span className="text-[#F2B705]">celebra</span> las
          lenguas del <span className="text-[#1B98A0]">Perú</span>
        </h1>
        <p className="font-['Mulish',sans-serif] text-lg text-white/90 max-w-[38ch] mb-6">
